...
<div class="container">
    ...
    <div class="card shadow mb-4">
        <div class="card-header m-0 font-weight-bold" style="background-color: #CBCFCF"><h4>Cadastro de Clientes Pessoa Juridica</h4></div>
        <div class="card-body">
  ...
  <div class="form-group col-md-3">
    ...
    <div class="form-group col-md-3">
      <label for="isMunicipal">Inscrição Municipal</label>
      <input type="text" class="form-control" id="isMunicipal" name="isMunicipal">
    </div>
    <div class="form-group col-md-2">
    <label for="isEstadual">CEP</label>
    <input type="number" class="form-control" id="isEstadual" name="isEstadual">
  </div>
    ...
    <div class="form-group col-md-3">
      ...
      <input type="tel" class="form-control" id="numeroTelefone" placeholder="(00) 0 0000-0000" name="numeroTelefone">
    </div>
    <div class="form-group col-md-3">
...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="ambos">Ambos</label>
                ...
                <!-- Conteúdo Pagamentos -->
                <div class="tab-pane fade" id="nav-pagamentos" role="tabpanel" aria-labelledby="nav-pagamentos-tab">+-+-+-+</div>
                <!-- Conteúdo historico -->
